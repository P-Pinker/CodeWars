...
public class AggregationKata4 {
    ...
    public static Map<String, Map<Student4.Gender, Long>> getTheNumberOfStudentsByGenderForEachDepartment(Stream<Student4> students) {

        return students.collect(
                Collectors.groupingBy(Student4::getDepartment, Collectors.groupingBy(Student4::getGender, Collectors.counting())));
